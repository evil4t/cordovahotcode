...
extern NSString *const kHCPCheckUpdateSuccessEvent;

extern NSString *const KHCPFileDownloaded;
...
extern NSString *const kHCPEventUserInfoFilesDownloadConfigKey;
