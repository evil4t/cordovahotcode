...
- (BOOL)executeApplicationConfigRequest:(HCPUpdateRequest *)request error:(NSError **)error;
- (BOOL)executeUpdateRequest:(HCPUpdateRequest *)request options: (HCPApplicationConfig *)newAppConfig error:(NSError **)error;
/**
