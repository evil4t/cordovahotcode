...
public class WorkerEvent extends PluginEventImpl {
    ...
    private static final String FILE_COUNTER = "counter";
    ...
    protected WorkerEvent(String eventName, FilesDownloadConfig filesDownloadConfig) {
        super(eventName, null);

        if (filesDownloadConfig != null) {
            data().put(FILE_COUNTER, filesDownloadConfig);
        }
    }
    ...
    public FilesDownloadConfig filesDownloadConfig() {
        final Map<String, Object> eventData = data();
        if (!eventData.containsKey(FILE_COUNTER)) {
            return null;
        }

        return (FilesDownloadConfig) eventData.get(FILE_COUNTER);
    }
}
