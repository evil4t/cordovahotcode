...
var exec = require('cordova/exec'),
  ...
  pluginNativeMethod = {
    ...
    DO_UPDATE: 'jsDoUpdate',
    RETRY_DOWNLOAD: 'jsRetryDownload',
    CANCEL_DOWNLOAD: 'jsCancelDownload'
  };
...
var chcp = {
  ...
  event: {
    ...
    CHECK_UPDATE_SUCCESS: 'chcp_checkUpdateSuccess',
    FILE_DOWNLOADED: 'chcp_filedownloaded'
  },
  ...
  checkUpdate: function(callback, options) {
    ...
    * 版本更新
    */
  doUpdate: function(callback, options) {
    callNativeMethod(pluginNativeMethod.DO_UPDATE, options, callback);
  },
               
  retryDownload: function() {
    callNativeMethod(pluginNativeMethod.RETRY_DOWNLOAD, null, null);
  },

  cancelDownload: function() {
    callNativeMethod(pluginNativeMethod.CANCEL_DOWNLOAD, null, null);
  }
};
